...
export function BotToggle({
  ...
  return (
    <button
      ...
      className="inline-flex min-h-[36px] items-center gap-2 rounded-full border-2 border-ink bg-surface py-1 pl-3 pr-1.5 text-xs font-bold text-ink shadow-card transition hover:bg-paper-2"
      title={title}
    >
