...
const CONTENT: Record<Role, RoleContent> = {
  student: {
    ...
    detailed: [
      ...
      "In the Manager game each round is a YEAR. You split your wealth between a risk-free asset, a line-up of fund managers and (usually) a low-cost index fund, and you're scored against the index itself. Read the prospectuses in the lobby before year 1.",
      ...
      "Manager game: every fund charges a fee every year, win or lose — each prospectus says how much. Some funds also take a share of the gains. Your total fees are revealed at the end.",
  ...
  professor: {
    ...
    detailed: [
      ...
      "Manager game: 25 years by default. Students allocate across a risk-free asset, 5 fund managers and an index fund that tracks the index for 0.05%/yr (switch it off in Advanced for the classic 'index you cannot buy' game), may lever up to 2×, and are ranked against 'The Index' — a no-fee passive competitor. Returns are continuous (the index averages 8% with 16% volatility); each manager adds its own beta, skill and noise.",
